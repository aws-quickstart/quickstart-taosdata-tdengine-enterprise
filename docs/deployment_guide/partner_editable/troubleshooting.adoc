...
*Q.* A resource type starting with *S3::* failed on stack deletion.

*A.* You may empty data in S3 bucket first before delete deployed stack or delete the bucket mananually after deleting stack. 
